...
# TODO
I used to write this on a different page, so putting this here now, but will have to write it out properly and merge with the text above:

## Filament History

When I ordered the A1 printer (11/23/2024) I also bought the following:
- The A1 came with a little bit of white PLA to help set it up and print benchy (status: used up)
